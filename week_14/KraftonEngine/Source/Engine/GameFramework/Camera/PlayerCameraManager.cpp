...
void APlayerCameraManager::SetScopeLens(float Radius, float OuterBlurRadius, float ZoomFOV, float Feather, float EdgeBlurRadius, float Intensity, float LookSensitivityScale, float BlendTime, float CenterOffsetX, float CenterOffsetY)
{
	SetScopeLensProfile(Radius, OuterBlurRadius, ZoomFOV, Feather, EdgeBlurRadius, Intensity, LookSensitivityScale, BlendTime, CenterOffsetX, CenterOffsetY);
...
void APlayerCameraManager::SetScopeLensProfile(float Radius, float OuterBlurRadius, float ZoomFOV, float Feather, float EdgeBlurRadius, float Intensity, float LookSensitivityScale, float BlendTime, float CenterOffsetX, float CenterOffsetY)
{
