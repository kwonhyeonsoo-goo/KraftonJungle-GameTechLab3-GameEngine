...
struct FAssetPackageHeader
{
	...
	static constexpr uint32 CurrentVersion = static_cast<uint32>(EAssetPackageSerializationVersion::SkeletalMeshPhysicsAssetPayload);
	...
	bool IsKnownVersion() const
	{
		return Version == LegacyVersion
			...
			|| Version == static_cast<uint32>(EAssetPackageSerializationVersion::SkeletonSocketPayload)
