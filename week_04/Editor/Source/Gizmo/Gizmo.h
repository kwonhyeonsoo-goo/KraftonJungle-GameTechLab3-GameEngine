...
public:
	...
	void BuildRenderCommands(AActor* SelectedActor, const FCameraViewInfo& ViewInfo, FRenderCommandQueue& OutQueue) const;
	bool BeginDrag(AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	bool UpdateDrag(AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	void UpdateHover(AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	void ClearHover();
	void EndDrag();
...
private:
	...
	bool EnsureRotationMeshes(const FCameraViewInfo& ViewInfo, const FVector& GizmoWorldLocation) const;
	bool EnsureScaleMeshes() const;
	EGizmoAxis HitTestAxis(AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight) const;
	bool BeginAxisDrag(EGizmoAxis Axis, AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	bool BeginTranslationDrag(EGizmoAxis Axis, AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	bool BeginRotationDrag(EGizmoAxis Axis, AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	bool BeginScaleDrag(EGizmoAxis Axis, AActor* SelectedActor, ULevel* Level, const FCameraViewInfo& ViewInfo, const FPicker& Picker, int32 ScreenX, int32 ScreenY, int32 ScreenWidth, int32 ScreenHeight);
	EGizmoAxis GetDisplayAxis() const;
	RotationDesc BuildRotationDesc(const FCameraViewInfo& ViewInfo, const FVector& GizmoWorldLocation) const;
	...
	float ComputeGizmoScale(const FVector& WorldPosition, const FCameraViewInfo& ViewInfo) const;
