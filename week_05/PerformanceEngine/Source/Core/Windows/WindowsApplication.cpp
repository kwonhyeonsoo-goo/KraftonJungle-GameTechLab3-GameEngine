...
FWindowsWindow* FWindowsApplication::MakeWindow(const WCHAR* Title, int Width, int Height, int X, int Y) const
{
...
void FWindowsApplication::AddMessageFilter(FWndProcFilter Filter) const
{
	if (MainWindow)
	{
...
void FWindowsApplication::SetOnResizeCallback(FOnResizeCallback Callback) const
{
	if (MainWindow)
	{
...
void FWindowsApplication::ShowWindow() const
{
	if (MainWindow)
	{
		MainWindow->Show();
